...
class IndependentSheet extends Model
{
     ...
     * @var string
     */
    // protected $interfaceType = \Dios\System\Multicasting\Interfaces\IndependentEntity::class;
    ...
    protected $entityTypeMapping = [
        self::SINGLE_TYPE => \Tests\Models\IndependentSheetTypes\SingleType::class,
    ];
